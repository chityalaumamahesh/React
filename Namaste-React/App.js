...
const heading = React.createElement(
  ...
  const Title=()=>(
    // <h1 id='heading' key='h2'>Food Villa</h1>
    <a href='/'>
    <img className='logo' 
     src='https://restaurant.eatapp.co/hubfs/Modern-Restaurant-Logo.jpg'
     alt='logo'/> 
     </a>
  );
  ...
  const Body =()=>{
    return(
      <div className='restaurant-list'>
        {restaurantList.map((restauarant)=>{
          return <RestaurantCard key={restauarant.data.id} {...restauarant.data}/>
        })}
      </div>
    )
  }
